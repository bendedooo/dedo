...
% legend('p=0.01','','p=0.1','','p=1','','p=10','','Location','best') % Legend: line
legend('','p=0.01','','p=0.1','','p=1','','p=10','Location','best') % Legend: dots
% legend('p=0.01','p=0.1','p=1','p=10','Location','best') % Legend: only plot
grid on
xlabel('Time Step')
